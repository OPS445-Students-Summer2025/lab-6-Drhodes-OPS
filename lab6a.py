...
class Student:
    ...
    def displayGPA(self):
        ...
        if len(self.courses) > 0:
            end_gpa = gpa / len(self.courses)
        else:
            end_gpa = 0.0

        return 'GPA of student ' + self.name + ' is ' + str(end_gpa)
    ...
    def displayCourses(self):
        ...
        for course_code in self.courses.keys():
            if self.courses[course_code] > 0:
                courses_with_credit.append(course_code)

        return courses_with_credit
